...
public class MobileNativeCode : ModuleRules
{
    ...
    private string PathStashNativeIOS
    {
        get { return Path.GetFullPath(Path.Combine(ModuleDirectory, "../../../../stash-native-main/iOS/StashPay/Sources/StashPay/")); }
    }
    ...
    public void LoadLib(ReadOnlyTargetRules Target)
    {
        ...
        else if (Target.Platform == UnrealTargetPlatform.IOS)
        {
            ...
            // Stash Pay SDK files (StashPayCard.h/m) are in Private/IOS/ObjC/ folder
