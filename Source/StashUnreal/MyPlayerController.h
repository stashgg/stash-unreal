...
class STASHUNREAL_API AMyPlayerController : public APlayerController
{
	GENERATED_BODY()
...
public:
	...
	// Stash API Configuration (can be configured in Blueprint Class Defaults)
	// Test API: https://test-api.stash.gg/sdk/server/checkout_links/generate_quick_pay_url
	// Production API: https://api.stash.gg/sdk/server/checkout_links/generate_quick_pay_url
	// Configure this in Blueprint Class Defaults under "Store" → "API" category
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Store|API")
	FString CheckoutApiUrl = TEXT("https://test-api.stash.gg/sdk/server/checkout_links/generate_quick_pay_url");
	
	// Stash API Authentication Token - Get this from Stash Dashboard
	// IMPORTANT: Never commit production tokens to version control!
	// Configure this in Blueprint Class Defaults under "Store" → "API" category
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Store|API")
	FString ApiAuthToken = TEXT("zyIbbfvO1ZRTaDt1VBZ5CJrwrdzyfDyLgt-VWNT-1uWj-5h42aeB6BNGAl8MGImw");
